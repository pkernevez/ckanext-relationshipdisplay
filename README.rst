...
.. image:: https://pypip.in/download/ckanext-relationshipdisplay/badge.svg
    :target: https://pypi.python.org/pypi//ckanext-relationshipdisplay/
    :alt: Downloads

.. image:: https://pypip.in/version/ckanext-relationshipdisplay/badge.svg
    :target: https://pypi.python.org/pypi/ckanext-relationshipdisplay/
    :alt: Latest Version

.. image:: https://pypip.in/py_versions/ckanext-relationshipdisplay/badge.svg
    :target: https://pypi.python.org/pypi/ckanext-relationshipdisplay/
    :alt: Supported Python versions

.. image:: https://pypip.in/status/ckanext-relationshipdisplay/badge.svg
    :target: https://pypi.python.org/pypi/ckanext-relationshipdisplay/
    :alt: Development Status

.. image:: https://pypip.in/license/ckanext-relationshipdisplay/badge.svg
    :target: https://pypi.python.org/pypi/ckanext-relationshipdisplay/
    :alt: License
...
---------------------------------
Registering ckanext-relationshipdisplay on PyPI
---------------------------------

ckanext-relationshipdisplay should be availabe on PyPI as
https://pypi.python.org/pypi/ckanext-relationshipdisplay. If that link doesn't work, then
...
----------------------------------------
Releasing a New Version of ckanext-relationshipdisplay
----------------------------------------

ckanext-relationshipdisplay is availabe on PyPI as https://pypi.python.org/pypi/ckanext-relationshipdisplay.
